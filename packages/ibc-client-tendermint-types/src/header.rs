...
impl Header {
    ...
    pub fn validate_basic<H: MerkleHash + Sha256 + Default>(
        ...
        #[cfg(feature = "solana")]
        {
            msg!("[types] validate_basic ENTRY");
        ...
        #[cfg(feature = "solana")]
        {
            msg!("[types] Before validators hash_with (EXPENSIVE MERKLE HASHING)");
            sol_log_compute_units();
        }
        ...
        #[cfg(feature = "solana")]
        {
            msg!("[types] After validators hash_with");
            sol_log_compute_units();
        }
