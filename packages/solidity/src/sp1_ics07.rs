...
/*
/// This module contains the full messages for the SP1 light client not exposed in public abi.
mod full_msgs {
    use super::super::ics26::IICS02ClientMsgs::Height;
    ...
    impl From<super::IICS07TendermintMsgs::TrustThreshold> for IICS07TendermintMsgs::TrustThreshold {
        fn from(trust_threshold: super::IICS07TendermintMsgs::TrustThreshold) -> Self {
            Self {
    ...
    impl From<super::IICS02ClientMsgs::Height> for Height {
        fn from(height: super::IICS02ClientMsgs::Height) -> Self {
            Self {
    ...
    #[cfg(feature = "rpc")]
    #[allow(clippy::fallible_impl_from)]
    impl From<super::sp1_ics07_tendermint::clientStateReturn> for IICS07TendermintMsgs::ClientState {
        fn from(client_state: super::sp1_ics07_tendermint::clientStateReturn) -> Self {
            Self {
