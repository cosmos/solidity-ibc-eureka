...
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, timelockedAdmin common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", timelockedAdmin)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address timelockedAdmin) returns()
func (_Contract *ContractSession) Initialize(timelockedAdmin common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, timelockedAdmin)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address timelockedAdmin) returns()
func (_Contract *ContractTransactorSession) Initialize(timelockedAdmin common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, timelockedAdmin)
}
...
//
// Solidity: event ICS02ClientAdded(string indexed clientId, (string,bytes[]) counterpartyInfo)
func (_Contract *ContractFilterer) FilterICS02ClientAdded(opts *bind.FilterOpts, clientId []string) (*ContractICS02ClientAddedIterator, error) {
	...
	logs, sub, err := _Contract.contract.FilterLogs(opts, "ICS02ClientAdded", clientIdRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event ICS02ClientAdded(string indexed clientId, (string,bytes[]) counterpartyInfo)
func (_Contract *ContractFilterer) WatchICS02ClientAdded(opts *bind.WatchOpts, sink chan<- *ContractICS02ClientAdded, clientId []string) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "ICS02ClientAdded", clientIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event ICS02ClientMigrated(string indexed subjectClientId, string substituteClientId)
func (_Contract *ContractFilterer) FilterICS02ClientMigrated(opts *bind.FilterOpts, subjectClientId []string) (*ContractICS02ClientMigratedIterator, error) {

	var subjectClientIdRule []interface{}
	for _, subjectClientIdItem := range subjectClientId {
		subjectClientIdRule = append(subjectClientIdRule, subjectClientIdItem)
	}

	logs, sub, err := _Contract.contract.FilterLogs(opts, "ICS02ClientMigrated", subjectClientIdRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event ICS02ClientMigrated(string indexed subjectClientId, string substituteClientId)
func (_Contract *ContractFilterer) WatchICS02ClientMigrated(opts *bind.WatchOpts, sink chan<- *ContractICS02ClientMigrated, subjectClientId []string) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "ICS02ClientMigrated", subjectClientIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event ICS02ClientUpdated(string indexed clientId, uint8 result)
func (_Contract *ContractFilterer) FilterICS02ClientUpdated(opts *bind.FilterOpts, clientId []string) (*ContractICS02ClientUpdatedIterator, error) {
	...
	logs, sub, err := _Contract.contract.FilterLogs(opts, "ICS02ClientUpdated", clientIdRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event ICS02ClientUpdated(string indexed clientId, uint8 result)
func (_Contract *ContractFilterer) WatchICS02ClientUpdated(opts *bind.WatchOpts, sink chan<- *ContractICS02ClientUpdated, clientId []string) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "ICS02ClientUpdated", clientIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event ICS02MisbehaviourSubmitted(string indexed clientId)
func (_Contract *ContractFilterer) FilterICS02MisbehaviourSubmitted(opts *bind.FilterOpts, clientId []string) (*ContractICS02MisbehaviourSubmittedIterator, error) {
	...
	logs, sub, err := _Contract.contract.FilterLogs(opts, "ICS02MisbehaviourSubmitted", clientIdRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event ICS02MisbehaviourSubmitted(string indexed clientId)
func (_Contract *ContractFilterer) WatchICS02MisbehaviourSubmitted(opts *bind.WatchOpts, sink chan<- *ContractICS02MisbehaviourSubmitted, clientId []string) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "ICS02MisbehaviourSubmitted", clientIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
