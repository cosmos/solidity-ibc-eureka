...
// GetAttestorSet is a free data retrieval call binding the contract method 0x977cd764.
//
// Solidity: function getAttestorSet() view returns(address[] attestorAddresses, uint8 minRequiredSigs)
func (_Contract *ContractCaller) GetAttestorSet(opts *bind.CallOpts) (struct {
	AttestorAddresses []common.Address
	MinRequiredSigs   uint8
}, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "getAttestorSet")
...
//
// Solidity: function getAttestorSet() view returns(address[] attestorAddresses, uint8 minRequiredSigs)
func (_Contract *ContractSession) GetAttestorSet() (struct {
	AttestorAddresses []common.Address
	MinRequiredSigs   uint8
}, error) {
	return _Contract.Contract.GetAttestorSet(&_Contract.CallOpts)
}

// GetAttestorSet is a free data retrieval call binding the contract method 0x977cd764.
//
// Solidity: function getAttestorSet() view returns(address[] attestorAddresses, uint8 minRequiredSigs)
func (_Contract *ContractCallerSession) GetAttestorSet() (struct {
	AttestorAddresses []common.Address
	MinRequiredSigs   uint8
}, error) {
	return _Contract.Contract.GetAttestorSet(&_Contract.CallOpts)
...
func (_Contract *ContractCaller) VerifyNonMembership(opts *bind.CallOpts, arg0 ILightClientMsgsMsgVerifyNonMembership) (*big.Int, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "verifyNonMembership", arg0)
...
//
// Solidity: function verifyNonMembership((bytes,(uint64,uint64),bytes[]) ) view returns(uint256)
func (_Contract *ContractSession) VerifyNonMembership(arg0 ILightClientMsgsMsgVerifyNonMembership) (*big.Int, error) {
	return _Contract.Contract.VerifyNonMembership(&_Contract.CallOpts, arg0)
}

// VerifyNonMembership is a free data retrieval call binding the contract method 0x4d6d9ffb.
//
// Solidity: function verifyNonMembership((bytes,(uint64,uint64),bytes[]) ) view returns(uint256)
func (_Contract *ContractCallerSession) VerifyNonMembership(arg0 ILightClientMsgsMsgVerifyNonMembership) (*big.Int, error) {
	return _Contract.Contract.VerifyNonMembership(&_Contract.CallOpts, arg0)
}
