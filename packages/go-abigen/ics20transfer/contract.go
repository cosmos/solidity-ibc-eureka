...
// InsertCustomERC20 is a paid mutator transaction binding the contract method 0xa664378b.
//
// Solidity: function insertCustomERC20(string denom, address token) returns()
func (_Contract *ContractTransactor) InsertCustomERC20(opts *bind.TransactOpts, denom string, token common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "insertCustomERC20", denom, token)
}

// InsertCustomERC20 is a paid mutator transaction binding the contract method 0xa664378b.
//
// Solidity: function insertCustomERC20(string denom, address token) returns()
func (_Contract *ContractSession) InsertCustomERC20(denom string, token common.Address) (*types.Transaction, error) {
	return _Contract.Contract.InsertCustomERC20(&_Contract.TransactOpts, denom, token)
}

// InsertCustomERC20 is a paid mutator transaction binding the contract method 0xa664378b.
//
// Solidity: function insertCustomERC20(string denom, address token) returns()
func (_Contract *ContractTransactorSession) InsertCustomERC20(denom string, token common.Address) (*types.Transaction, error) {
	return _Contract.Contract.InsertCustomERC20(&_Contract.TransactOpts, denom, token)
}
