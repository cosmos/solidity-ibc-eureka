...
// Initialize is a paid mutator transaction binding the contract method 0x489b3940.
//
// Solidity: function initialize(address owner_, string name_, string symbol_, address ics27Gmp_, string clientId_, string cosmosAccount_, address bridge_) returns()
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, owner_ common.Address, name_ string, symbol_ string, ics27Gmp_ common.Address, clientId_ string, cosmosAccount_ string, bridge_ common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", owner_, name_, symbol_, ics27Gmp_, clientId_, cosmosAccount_, bridge_)
}

// Initialize is a paid mutator transaction binding the contract method 0x489b3940.
//
// Solidity: function initialize(address owner_, string name_, string symbol_, address ics27Gmp_, string clientId_, string cosmosAccount_, address bridge_) returns()
func (_Contract *ContractSession) Initialize(owner_ common.Address, name_ string, symbol_ string, ics27Gmp_ common.Address, clientId_ string, cosmosAccount_ string, bridge_ common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, owner_, name_, symbol_, ics27Gmp_, clientId_, cosmosAccount_, bridge_)
}

// Initialize is a paid mutator transaction binding the contract method 0x489b3940.
//
// Solidity: function initialize(address owner_, string name_, string symbol_, address ics27Gmp_, string clientId_, string cosmosAccount_, address bridge_) returns()
func (_Contract *ContractTransactorSession) Initialize(owner_ common.Address, name_ string, symbol_ string, ics27Gmp_ common.Address, clientId_ string, cosmosAccount_ string, bridge_ common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, owner_, name_, symbol_, ics27Gmp_, clientId_, cosmosAccount_, bridge_)
}
...
// Transfer0 is a paid mutator transaction binding the contract method 0xca32ab86.
//
// Solidity: function transfer(uint256 amount, string receiver) returns()
func (_Contract *ContractTransactor) Transfer0(opts *bind.TransactOpts, amount *big.Int, receiver string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "transfer0", amount, receiver)
}

// Transfer0 is a paid mutator transaction binding the contract method 0xca32ab86.
//
// Solidity: function transfer(uint256 amount, string receiver) returns()
func (_Contract *ContractSession) Transfer0(amount *big.Int, receiver string) (*types.Transaction, error) {
	return _Contract.Contract.Transfer0(&_Contract.TransactOpts, amount, receiver)
}

// Transfer0 is a paid mutator transaction binding the contract method 0xca32ab86.
//
// Solidity: function transfer(uint256 amount, string receiver) returns()
func (_Contract *ContractTransactorSession) Transfer0(amount *big.Int, receiver string) (*types.Transaction, error) {
	return _Contract.Contract.Transfer0(&_Contract.TransactOpts, amount, receiver)
}
