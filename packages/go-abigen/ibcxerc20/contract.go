...
// Initialize is a paid mutator transaction binding the contract method 0x1ed4fb2c.
//
// Solidity: function initialize(address owner_, string name_, string symbol_, address ics27Gmp_, string clientId_) returns()
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, owner_ common.Address, name_ string, symbol_ string, ics27Gmp_ common.Address, clientId_ string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", owner_, name_, symbol_, ics27Gmp_, clientId_)
}

// Initialize is a paid mutator transaction binding the contract method 0x1ed4fb2c.
//
// Solidity: function initialize(address owner_, string name_, string symbol_, address ics27Gmp_, string clientId_) returns()
func (_Contract *ContractSession) Initialize(owner_ common.Address, name_ string, symbol_ string, ics27Gmp_ common.Address, clientId_ string) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, owner_, name_, symbol_, ics27Gmp_, clientId_)
}

// Initialize is a paid mutator transaction binding the contract method 0x1ed4fb2c.
//
// Solidity: function initialize(address owner_, string name_, string symbol_, address ics27Gmp_, string clientId_) returns()
func (_Contract *ContractTransactorSession) Initialize(owner_ common.Address, name_ string, symbol_ string, ics27Gmp_ common.Address, clientId_ string) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, owner_, name_, symbol_, ics27Gmp_, clientId_)
}
