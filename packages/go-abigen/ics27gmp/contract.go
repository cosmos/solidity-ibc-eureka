...
// GetAccountIdentifier is a free data retrieval call binding the contract method 0xe57d7de0.
//
// Solidity: function getAccountIdentifier(address account) view returns((string,string,bytes))
func (_Contract *ContractCaller) GetAccountIdentifier(opts *bind.CallOpts, account common.Address) (IICS27GMPMsgsAccountIdentifier, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "getAccountIdentifier", account)

	if err != nil {
		return *new(IICS27GMPMsgsAccountIdentifier), err
	}

	out0 := *abi.ConvertType(out[0], new(IICS27GMPMsgsAccountIdentifier)).(*IICS27GMPMsgsAccountIdentifier)
...
//
// Solidity: function getAccountIdentifier(address account) view returns((string,string,bytes))
func (_Contract *ContractSession) GetAccountIdentifier(account common.Address) (IICS27GMPMsgsAccountIdentifier, error) {
	return _Contract.Contract.GetAccountIdentifier(&_Contract.CallOpts, account)
}

// GetAccountIdentifier is a free data retrieval call binding the contract method 0xe57d7de0.
//
// Solidity: function getAccountIdentifier(address account) view returns((string,string,bytes))
func (_Contract *ContractCallerSession) GetAccountIdentifier(account common.Address) (IICS27GMPMsgsAccountIdentifier, error) {
	return _Contract.Contract.GetAccountIdentifier(&_Contract.CallOpts, account)
}
...
//
// Solidity: function initialize(address ics26_, address accountLogic, address authority) returns()
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, ics26_ common.Address, accountLogic common.Address, authority common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", ics26_, accountLogic, authority)
}

// Initialize is a paid mutator transaction binding the contract method 0xc0c53b8b.
//
// Solidity: function initialize(address ics26_, address accountLogic, address authority) returns()
func (_Contract *ContractSession) Initialize(ics26_ common.Address, accountLogic common.Address, authority common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, ics26_, accountLogic, authority)
}

// Initialize is a paid mutator transaction binding the contract method 0xc0c53b8b.
//
// Solidity: function initialize(address ics26_, address accountLogic, address authority) returns()
func (_Contract *ContractTransactorSession) Initialize(ics26_ common.Address, accountLogic common.Address, authority common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, ics26_, accountLogic, authority)
}
...
// SendCall is a paid mutator transaction binding the contract method 0x7e5a6566.
//
// Solidity: function sendCall((string,string,bytes,bytes,uint64,string) msg_) returns(uint64)
