...
```sh
# Start all services
just start-attestor-services

# Test the services
just test-attestor-services

# Stop all services
just stop-attestor-services
```
...
For detailed configuration and usage, see [docs/README-docker.md](docs/README-docker.md).
