...
//
// Solidity: function initialize(address admin_) returns()
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, admin_ common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", admin_)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address admin_) returns()
func (_Contract *ContractSession) Initialize(admin_ common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, admin_)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address admin_) returns()
func (_Contract *ContractTransactorSession) Initialize(admin_ common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, admin_)
}
