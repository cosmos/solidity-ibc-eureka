...
//
// Solidity: function nextSequenceSend(string clientId) returns(uint32)
func (_Contract *ContractTransactor) NextSequenceSend(opts *bind.TransactOpts, clientId string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "nextSequenceSend", clientId)
}

// NextSequenceSend is a paid mutator transaction binding the contract method 0x676bd316.
//
// Solidity: function nextSequenceSend(string clientId) returns(uint32)
func (_Contract *ContractSession) NextSequenceSend(clientId string) (*types.Transaction, error) {
	return _Contract.Contract.NextSequenceSend(&_Contract.TransactOpts, clientId)
}

// NextSequenceSend is a paid mutator transaction binding the contract method 0x676bd316.
//
// Solidity: function nextSequenceSend(string clientId) returns(uint32)
func (_Contract *ContractTransactorSession) NextSequenceSend(clientId string) (*types.Transaction, error) {
	return _Contract.Contract.NextSequenceSend(&_Contract.TransactOpts, clientId)
}
