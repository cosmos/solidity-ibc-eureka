...
func (_Contract *ContractCaller) IbcERC20Contract(opts *bind.CallOpts, denom IICS20TransferMsgsDenom) (common.Address, error) {
	var out []interface{}
...
//
// Solidity: function ibcERC20Contract((string,(string,string)[]) denom) view returns(address)
func (_Contract *ContractSession) IbcERC20Contract(denom IICS20TransferMsgsDenom) (common.Address, error) {
...
//
// Solidity: function ibcERC20Contract((string,(string,string)[]) denom) view returns(address)
func (_Contract *ContractCallerSession) IbcERC20Contract(denom IICS20TransferMsgsDenom) (common.Address, error) {
	return _Contract.Contract.IbcERC20Contract(&_Contract.CallOpts, denom)
}
