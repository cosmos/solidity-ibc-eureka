...
// Initialize is a paid mutator transaction binding the contract method 0x6a0597f9.
//
// Solidity: function initialize(address ics26Router, address escrowLogic, address ibcERC20Logic, address[] pausers, address[] unpausers, address permit2) returns()
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, ics26Router common.Address, escrowLogic common.Address, ibcERC20Logic common.Address, pausers []common.Address, unpausers []common.Address, permit2 common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", ics26Router, escrowLogic, ibcERC20Logic, pausers, unpausers, permit2)
}

// Initialize is a paid mutator transaction binding the contract method 0x6a0597f9.
//
// Solidity: function initialize(address ics26Router, address escrowLogic, address ibcERC20Logic, address[] pausers, address[] unpausers, address permit2) returns()
func (_Contract *ContractSession) Initialize(ics26Router common.Address, escrowLogic common.Address, ibcERC20Logic common.Address, pausers []common.Address, unpausers []common.Address, permit2 common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, ics26Router, escrowLogic, ibcERC20Logic, pausers, unpausers, permit2)
}

// Initialize is a paid mutator transaction binding the contract method 0x6a0597f9.
//
// Solidity: function initialize(address ics26Router, address escrowLogic, address ibcERC20Logic, address[] pausers, address[] unpausers, address permit2) returns()
func (_Contract *ContractTransactorSession) Initialize(ics26Router common.Address, escrowLogic common.Address, ibcERC20Logic common.Address, pausers []common.Address, unpausers []common.Address, permit2 common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, ics26Router, escrowLogic, ibcERC20Logic, pausers, unpausers, permit2)
}
