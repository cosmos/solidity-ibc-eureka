...
//
// Solidity: function initialize(address ics26Router, address escrowBeacon, address ibcERC20Beacon, address pauser, address permit2) returns()
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, ics26Router common.Address, escrowBeacon common.Address, ibcERC20Beacon common.Address, pauser common.Address, permit2 common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", ics26Router, escrowBeacon, ibcERC20Beacon, pauser, permit2)
}

// Initialize is a paid mutator transaction binding the contract method 0x1459457a.
//
// Solidity: function initialize(address ics26Router, address escrowBeacon, address ibcERC20Beacon, address pauser, address permit2) returns()
func (_Contract *ContractSession) Initialize(ics26Router common.Address, escrowBeacon common.Address, ibcERC20Beacon common.Address, pauser common.Address, permit2 common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, ics26Router, escrowBeacon, ibcERC20Beacon, pauser, permit2)
}

// Initialize is a paid mutator transaction binding the contract method 0x1459457a.
//
// Solidity: function initialize(address ics26Router, address escrowBeacon, address ibcERC20Beacon, address pauser, address permit2) returns()
func (_Contract *ContractTransactorSession) Initialize(ics26Router common.Address, escrowBeacon common.Address, ibcERC20Beacon common.Address, pauser common.Address, permit2 common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, ics26Router, escrowBeacon, ibcERC20Beacon, pauser, permit2)
}
...
// PermitSendTransfer is a paid mutator transaction binding the contract method 0x2f79a453.
//
// Solidity: function permitSendTransfer((address,uint256,string,string,string,uint64,string) msg_, ((address,uint256),uint256,uint256) permit, bytes signature) returns(uint32 sequence)
func (_Contract *ContractTransactor) PermitSendTransfer(opts *bind.TransactOpts, msg_ IICS20TransferMsgsSendTransferMsg, permit ISignatureTransferPermitTransferFrom, signature []byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "permitSendTransfer", msg_, permit, signature)
}

// PermitSendTransfer is a paid mutator transaction binding the contract method 0x2f79a453.
//
// Solidity: function permitSendTransfer((address,uint256,string,string,string,uint64,string) msg_, ((address,uint256),uint256,uint256) permit, bytes signature) returns(uint32 sequence)
func (_Contract *ContractSession) PermitSendTransfer(msg_ IICS20TransferMsgsSendTransferMsg, permit ISignatureTransferPermitTransferFrom, signature []byte) (*types.Transaction, error) {
	return _Contract.Contract.PermitSendTransfer(&_Contract.TransactOpts, msg_, permit, signature)
}

// PermitSendTransfer is a paid mutator transaction binding the contract method 0x2f79a453.
//
// Solidity: function permitSendTransfer((address,uint256,string,string,string,uint64,string) msg_, ((address,uint256),uint256,uint256) permit, bytes signature) returns(uint32 sequence)
func (_Contract *ContractTransactorSession) PermitSendTransfer(msg_ IICS20TransferMsgsSendTransferMsg, permit ISignatureTransferPermitTransferFrom, signature []byte) (*types.Transaction, error) {
	return _Contract.Contract.PermitSendTransfer(&_Contract.TransactOpts, msg_, permit, signature)
}
