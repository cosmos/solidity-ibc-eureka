...
// IbcERC20Contracts is a free data retrieval call binding the contract method 0x76cc7fc9.
//
// Solidity: function ibcERC20Contracts(string denom) view returns(address)
func (_Contract *ContractCaller) IbcERC20Contracts(opts *bind.CallOpts, denom string) (common.Address, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "ibcERC20Contracts", denom)
...
//
// Solidity: function ibcERC20Contracts(string denom) view returns(address)
func (_Contract *ContractSession) IbcERC20Contracts(denom string) (common.Address, error) {
	return _Contract.Contract.IbcERC20Contracts(&_Contract.CallOpts, denom)
}

// IbcERC20Contracts is a free data retrieval call binding the contract method 0x76cc7fc9.
//
// Solidity: function ibcERC20Contracts(string denom) view returns(address)
func (_Contract *ContractCallerSession) IbcERC20Contracts(denom string) (common.Address, error) {
	return _Contract.Contract.IbcERC20Contracts(&_Contract.CallOpts, denom)
}
