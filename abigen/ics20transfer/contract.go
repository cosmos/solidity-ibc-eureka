...
// IbcDenomContracts is a free data retrieval call binding the contract method 0x5914c1c9.
//
// Solidity: function _ibcDenomContracts(string denom) view returns(address ibcERC20Contract)
func (_Contract *ContractCaller) IbcDenomContracts(opts *bind.CallOpts, denom string) (common.Address, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "_ibcDenomContracts", denom)
...
//
// Solidity: function _ibcDenomContracts(string denom) view returns(address ibcERC20Contract)
func (_Contract *ContractSession) IbcDenomContracts(denom string) (common.Address, error) {
	return _Contract.Contract.IbcDenomContracts(&_Contract.CallOpts, denom)
}

// IbcDenomContracts is a free data retrieval call binding the contract method 0x5914c1c9.
//
// Solidity: function _ibcDenomContracts(string denom) view returns(address ibcERC20Contract)
func (_Contract *ContractCallerSession) IbcDenomContracts(denom string) (common.Address, error) {
	return _Contract.Contract.IbcDenomContracts(&_Contract.CallOpts, denom)
}
