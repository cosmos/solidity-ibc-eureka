...
// IbcDenomContracts is a free data retrieval call binding the contract method 0x6d4505c9.
//
// Solidity: function ibcDenomContracts(string denom) view returns(address)
func (_Contract *ContractCaller) IbcDenomContracts(opts *bind.CallOpts, denom string) (common.Address, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "ibcDenomContracts", denom)
