...
// Multipass is a paid mutator transaction binding the contract method 0xd42aeb52.
//
// Solidity: function multipass(bytes[] data) returns(bytes[] results)
func (_Contract *ContractTransactor) Multipass(opts *bind.TransactOpts, data [][]byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "multipass", data)
}

// Multipass is a paid mutator transaction binding the contract method 0xd42aeb52.
//
// Solidity: function multipass(bytes[] data) returns(bytes[] results)
func (_Contract *ContractSession) Multipass(data [][]byte) (*types.Transaction, error) {
	return _Contract.Contract.Multipass(&_Contract.TransactOpts, data)
}

// Multipass is a paid mutator transaction binding the contract method 0xd42aeb52.
//
// Solidity: function multipass(bytes[] data) returns(bytes[] results)
func (_Contract *ContractTransactorSession) Multipass(data [][]byte) (*types.Transaction, error) {
	return _Contract.Contract.Multipass(&_Contract.TransactOpts, data)
}
