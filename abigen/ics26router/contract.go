...
// IsPacketReceiveSuccessful is a free data retrieval call binding the contract method 0xd07a5ee8.
//
// Solidity: function isPacketReceiveSuccessful((uint32,string,string,uint64,(string,string,string,string,bytes)[]) packet) view returns(bool)
...
// IsPacketReceived is a free data retrieval call binding the contract method 0xdaf0bd45.
//
// Solidity: function isPacketReceived((uint32,string,string,uint64,(string,string,string,string,bytes)[]) packet) view returns(bool)
