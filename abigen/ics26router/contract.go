...
//
// Solidity: function initialize(address admin_, address ics02Client) returns()
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, admin_ common.Address, ics02Client common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", admin_, ics02Client)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address admin_, address ics02Client) returns()
func (_Contract *ContractSession) Initialize(admin_ common.Address, ics02Client common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, admin_, ics02Client)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address admin_, address ics02Client) returns()
func (_Contract *ContractTransactorSession) Initialize(admin_ common.Address, ics02Client common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, admin_, ics02Client)
}
