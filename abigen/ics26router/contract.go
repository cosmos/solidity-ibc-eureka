...
// ICS04CHANNEL is a free data retrieval call binding the contract method 0x8d9ce506.
//
// Solidity: function ICS04_CHANNEL() view returns(address)
func (_Contract *ContractCaller) ICS04CHANNEL(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "ICS04_CHANNEL")
...
//
// Solidity: function ICS04_CHANNEL() view returns(address)
func (_Contract *ContractSession) ICS04CHANNEL() (common.Address, error) {
	return _Contract.Contract.ICS04CHANNEL(&_Contract.CallOpts)
}

// ICS04CHANNEL is a free data retrieval call binding the contract method 0x8d9ce506.
//
// Solidity: function ICS04_CHANNEL() view returns(address)
func (_Contract *ContractCallerSession) ICS04CHANNEL() (common.Address, error) {
	return _Contract.Contract.ICS04CHANNEL(&_Contract.CallOpts)
}
...
//
// Solidity: function initialize(address owner_, address icsCore) returns()
func (_Contract *ContractTransactor) Initialize(opts *bind.TransactOpts, owner_ common.Address, icsCore common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "initialize", owner_, icsCore)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address owner_, address icsCore) returns()
func (_Contract *ContractSession) Initialize(owner_ common.Address, icsCore common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, owner_, icsCore)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address owner_, address icsCore) returns()
func (_Contract *ContractTransactorSession) Initialize(owner_ common.Address, icsCore common.Address) (*types.Transaction, error) {
	return _Contract.Contract.Initialize(&_Contract.TransactOpts, owner_, icsCore)
}
