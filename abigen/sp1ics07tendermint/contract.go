...
func (_Contract *ContractCaller) IsFrozen(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "isFrozen")
...
//
// Solidity: function isFrozen() view returns(bool)
func (_Contract *ContractSession) IsFrozen() (bool, error) {
	return _Contract.Contract.IsFrozen(&_Contract.CallOpts)
}

// IsFrozen is a free data retrieval call binding the contract method 0x33eeb147.
//
// Solidity: function isFrozen() view returns(bool)
func (_Contract *ContractCallerSession) IsFrozen() (bool, error) {
	return _Contract.Contract.IsFrozen(&_Contract.CallOpts)
}
