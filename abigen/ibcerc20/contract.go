...
// ESCROW is a free data retrieval call binding the contract method 0xe681c4aa.
//
...
// ICS20 is a free data retrieval call binding the contract method 0xcecf7239.
//
...
// FullDenom is a free data retrieval call binding the contract method 0xe361be94.
//
// Solidity: function fullDenom() view returns((string,(string,string)[]))
func (_Contract *ContractCaller) FullDenom(opts *bind.CallOpts) (ICS20LibDenom, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "fullDenom")

	if err != nil {
		return *new(ICS20LibDenom), err
	}

	out0 := *abi.ConvertType(out[0], new(ICS20LibDenom)).(*ICS20LibDenom)
...
//
// Solidity: function fullDenom() view returns((string,(string,string)[]))
func (_Contract *ContractSession) FullDenom() (ICS20LibDenom, error) {
	return _Contract.Contract.FullDenom(&_Contract.CallOpts)
}

// FullDenom is a free data retrieval call binding the contract method 0xe361be94.
//
// Solidity: function fullDenom() view returns((string,(string,string)[]))
func (_Contract *ContractCallerSession) FullDenom() (ICS20LibDenom, error) {
	return _Contract.Contract.FullDenom(&_Contract.CallOpts)
}
