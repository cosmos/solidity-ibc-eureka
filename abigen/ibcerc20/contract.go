...
type IICS20TransferMsgsHop struct {
	PortId   string
	ClientId string
}
...
func (_Contract *ContractCaller) FullDenom(opts *bind.CallOpts) (IICS20TransferMsgsDenom, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "fullDenom")

	if err != nil {
		return *new(IICS20TransferMsgsDenom), err
	}

	out0 := *abi.ConvertType(out[0], new(IICS20TransferMsgsDenom)).(*IICS20TransferMsgsDenom)
...
//
// Solidity: function fullDenom() view returns((string,(string,string)[]))
func (_Contract *ContractSession) FullDenom() (IICS20TransferMsgsDenom, error) {
...
//
// Solidity: function fullDenom() view returns((string,(string,string)[]))
func (_Contract *ContractCallerSession) FullDenom() (IICS20TransferMsgsDenom, error) {
	return _Contract.Contract.FullDenom(&_Contract.CallOpts)
}
