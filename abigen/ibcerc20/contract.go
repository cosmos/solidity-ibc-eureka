...
// METADATASETTERROLE is a free data retrieval call binding the contract method 0x302ad53a.
//
// Solidity: function METADATA_SETTER_ROLE() view returns(bytes32)
func (_Contract *ContractCaller) METADATASETTERROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "METADATA_SETTER_ROLE")
...
//
// Solidity: function METADATA_SETTER_ROLE() view returns(bytes32)
func (_Contract *ContractSession) METADATASETTERROLE() ([32]byte, error) {
	return _Contract.Contract.METADATASETTERROLE(&_Contract.CallOpts)
}

// METADATASETTERROLE is a free data retrieval call binding the contract method 0x302ad53a.
//
// Solidity: function METADATA_SETTER_ROLE() view returns(bytes32)
func (_Contract *ContractCallerSession) METADATASETTERROLE() ([32]byte, error) {
	return _Contract.Contract.METADATASETTERROLE(&_Contract.CallOpts)
}
...
// GrantMetadataSetterRole is a paid mutator transaction binding the contract method 0xf70b4c8e.
//
// Solidity: function grantMetadataSetterRole(address account) returns()
func (_Contract *ContractTransactor) GrantMetadataSetterRole(opts *bind.TransactOpts, account common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "grantMetadataSetterRole", account)
}

// GrantMetadataSetterRole is a paid mutator transaction binding the contract method 0xf70b4c8e.
//
// Solidity: function grantMetadataSetterRole(address account) returns()
func (_Contract *ContractSession) GrantMetadataSetterRole(account common.Address) (*types.Transaction, error) {
	return _Contract.Contract.GrantMetadataSetterRole(&_Contract.TransactOpts, account)
}

// GrantMetadataSetterRole is a paid mutator transaction binding the contract method 0xf70b4c8e.
//
// Solidity: function grantMetadataSetterRole(address account) returns()
func (_Contract *ContractTransactorSession) GrantMetadataSetterRole(account common.Address) (*types.Transaction, error) {
	return _Contract.Contract.GrantMetadataSetterRole(&_Contract.TransactOpts, account)
}
...
// RevokeMetadataSetterRole is a paid mutator transaction binding the contract method 0x418f05ca.
//
// Solidity: function revokeMetadataSetterRole(address account) returns()
func (_Contract *ContractTransactor) RevokeMetadataSetterRole(opts *bind.TransactOpts, account common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "revokeMetadataSetterRole", account)
}

// RevokeMetadataSetterRole is a paid mutator transaction binding the contract method 0x418f05ca.
//
// Solidity: function revokeMetadataSetterRole(address account) returns()
func (_Contract *ContractSession) RevokeMetadataSetterRole(account common.Address) (*types.Transaction, error) {
	return _Contract.Contract.RevokeMetadataSetterRole(&_Contract.TransactOpts, account)
}

// RevokeMetadataSetterRole is a paid mutator transaction binding the contract method 0x418f05ca.
//
// Solidity: function revokeMetadataSetterRole(address account) returns()
func (_Contract *ContractTransactorSession) RevokeMetadataSetterRole(account common.Address) (*types.Transaction, error) {
	return _Contract.Contract.RevokeMetadataSetterRole(&_Contract.TransactOpts, account)
}
