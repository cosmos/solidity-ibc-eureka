module github.com/cosmos/solidity-ibc-eureka/deployics08wasmeth
...
require (
	...
	github.com/cosmos/solidity-ibc-eureka/abigen v0.0.0 // indirect
...
replace (
	github.com/cosmos/solidity-ibc-eureka/abigen => ../../abigen
