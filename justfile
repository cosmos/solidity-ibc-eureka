...
generate-abi: build-contracts
	...
	jq '.abi' out/IBCXERC20.sol/IBCXERC20.json > abi/IBCXERC20.json
	...
	abigen --abi abi/IBCXERC20.json --pkg ibcxerc20 --type Contract --out packages/go-abigen/ibcxerc20/contract.go
