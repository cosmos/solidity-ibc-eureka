...
check-cometbft-fixtures: _check-cometbft-fixture-dependency
  ...
  trap 'rm -f "$update_tmp" "$update20_tmp" "$skip_tmp" "$skip20_tmp" "$skip_insufficient_trusted_tmp" "$parser_tmp" "$router_tmp" "$misbehaviour_tmp" "$membership_tmp" "$non_membership_tmp"' EXIT
