...
mod tests {
    ...
    fn test_upload_payload_chunk_success() {
        ...
        let instruction_data = crate::instruction::UploadPayloadChunk { msg };
        ...
        assert_eq!(stored_chunk.payload_index, payload_index);
    ...
    #[test]
    fn test_upload_payload_chunk_max_size() {
        let payer = Pubkey::new_unique();
        let client_id = "test-client";
        let sequence = 1u64;
        let payload_index = 0u8;
    ...
    #[test]
    fn test_upload_payload_chunk_multiple_chunks() {
        // Test uploading multiple chunks for same packet but different indices
        let payer = Pubkey::new_unique();
        let client_id = "test-client";
        let sequence = 1u64;
        let payload_index = 0u8;
        ...
        let instruction_0 = Instruction {
            ...
            data: crate::instruction::UploadPayloadChunk { msg: msg_0 }.data(),
        };
        ...
        let instruction_1 = Instruction {
            ...
            data: crate::instruction::UploadPayloadChunk { msg: msg_1 }.data(),
        };
    ...
    #[test]
    fn test_upload_payload_chunk_different_payloads() {
        // Test uploading chunks for different payloads
        let payer = Pubkey::new_unique();
        let client_id = "test-client";
        let sequence = 1u64;
        let chunk_index = 0u8;
