...
pub const ICS07_INITIALIZE_DISCRIMINATOR: [u8; 8] = {
    // Pre-computed SHA256("global:initialize")[0..8]
    // This matches Anchor's discriminator generation for instruction "initialize"
