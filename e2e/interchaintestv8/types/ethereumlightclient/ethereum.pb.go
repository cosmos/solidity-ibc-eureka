...
func (m *StorageProof) GetKey() []byte {
	if m != nil {
		return m.Key
	}
	return nil
...
func (m *StorageProof) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
type ClientState struct {
	...
	LatestSlot                   uint64          `protobuf:"varint,9,opt,name=latest_slot,json=latestSlot,proto3" json:"latest_slot,omitempty"`
	FrozenHeight                 *types.Height   `protobuf:"bytes,10,opt,name=frozen_height,json=frozenHeight,proto3" json:"frozen_height,omitempty"`
	IbcCommitmentSlot            []byte          `protobuf:"bytes,11,opt,name=ibc_commitment_slot,json=ibcCommitmentSlot,proto3" json:"ibc_commitment_slot,omitempty"`
	IbcContractAddress           []byte          `protobuf:"bytes,12,opt,name=ibc_contract_address,json=ibcContractAddress,proto3" json:"ibc_contract_address,omitempty"`
}
...
// TODO: This should be an enum containing either sync committee update or
// finality update.
type Header struct {
...
var fileDescriptor_3d5f6a181a17c968 = []byte{
	...
	,
}
