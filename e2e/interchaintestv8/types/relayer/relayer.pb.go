...
func (x *RelayByTxResponse) GetTxs() [][]byte {
	if x != nil {
		return x.Txs
	}
	return nil
...
func (x *ChunkedMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChunkedMetadata) ProtoMessage() {}

func (x *ChunkedMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_relayer_relayer_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ChunkedMetadata) GetTotalChunks() uint32 {
	if x != nil {
...
var file_relayer_relayer_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_relayer_relayer_proto_goTypes = []any{
	...
	(*ChunkedMetadata)(nil),      // 6: relayer.ChunkedMetadata
	(*InfoRequest)(nil),          // 7: relayer.InfoRequest
	(*InfoResponse)(nil),         // 8: relayer.InfoResponse
	(*Chain)(nil),                // 9: relayer.Chain
	nil,                          // 10: relayer.CreateClientRequest.ParametersEntry
