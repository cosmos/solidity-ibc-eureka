...
// DEFAULTCOSMOSDECIMALS is a free data retrieval call binding the contract method 0x846a4f09.
//
// Solidity: function DEFAULT_COSMOS_DECIMALS() view returns(uint8)
func (_Contract *ContractCaller) DEFAULTCOSMOSDECIMALS(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "DEFAULT_COSMOS_DECIMALS")
...
//
// Solidity: function DEFAULT_COSMOS_DECIMALS() view returns(uint8)
func (_Contract *ContractSession) DEFAULTCOSMOSDECIMALS() (uint8, error) {
	return _Contract.Contract.DEFAULTCOSMOSDECIMALS(&_Contract.CallOpts)
}

// DEFAULTCOSMOSDECIMALS is a free data retrieval call binding the contract method 0x846a4f09.
//
// Solidity: function DEFAULT_COSMOS_DECIMALS() view returns(uint8)
func (_Contract *ContractCallerSession) DEFAULTCOSMOSDECIMALS() (uint8, error) {
	return _Contract.Contract.DEFAULTCOSMOSDECIMALS(&_Contract.CallOpts)
}
