...
// ICS20LibUnwrappedFungibleTokenPacketData is an auto generated low-level Go binding around an user-defined struct.
type ICS20LibUnwrappedFungibleTokenPacketData struct {
...
// OnAcknowledgementPacket is a paid mutator transaction binding the contract method 0x72d03616.
//
// Solidity: function onAcknowledgementPacket(((uint32,uint32,string,string,string,string,string,bytes),bytes,address) msg_) returns()
...
// OnRecvPacket is a paid mutator transaction binding the contract method 0x07b2047c.
//
// Solidity: function onRecvPacket(((uint32,uint32,string,string,string,string,string,bytes),address) ) returns(bytes)
func (_Contract *ContractTransactor) OnRecvPacket(opts *bind.TransactOpts, arg0 IIBCAppCallbacksOnRecvPacketCallback) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "onRecvPacket", arg0)
}

// OnRecvPacket is a paid mutator transaction binding the contract method 0x07b2047c.
//
// Solidity: function onRecvPacket(((uint32,uint32,string,string,string,string,string,bytes),address) ) returns(bytes)
func (_Contract *ContractSession) OnRecvPacket(arg0 IIBCAppCallbacksOnRecvPacketCallback) (*types.Transaction, error) {
	return _Contract.Contract.OnRecvPacket(&_Contract.TransactOpts, arg0)
}

// OnRecvPacket is a paid mutator transaction binding the contract method 0x07b2047c.
//
// Solidity: function onRecvPacket(((uint32,uint32,string,string,string,string,string,bytes),address) ) returns(bytes)
func (_Contract *ContractTransactorSession) OnRecvPacket(arg0 IIBCAppCallbacksOnRecvPacketCallback) (*types.Transaction, error) {
	return _Contract.Contract.OnRecvPacket(&_Contract.TransactOpts, arg0)
}

// OnSendPacket is a paid mutator transaction binding the contract method 0xa49f7ec4.
//
// Solidity: function onSendPacket(((uint32,uint32,string,string,string,string,string,bytes),address) msg_) returns()
...
// OnTimeoutPacket is a paid mutator transaction binding the contract method 0xc9864a8c.
//
// Solidity: function onTimeoutPacket(((uint32,uint32,string,string,string,string,string,bytes),address) msg_) returns()
...
// SendTransfer is a paid mutator transaction binding the contract method 0x2e1ee7d2.
//
// Solidity: function sendTransfer((string,uint256,string,string,string,uint32,string) msg_) returns(uint32)
...
type ContractICS20Acknowledgement struct {
	PacketData      ICS20LibUnwrappedFungibleTokenPacketData
	Acknowledgement []byte
	Success         bool
	Raw             types.Log // Blockchain specific contextual infos
}

// FilterICS20Acknowledgement is a free log retrieval operation binding the contract event 0xe89bcee3264240450629e36ea20920e66e8bb6948e95d13fb2dfb8dc1156c55d.
//
// Solidity: event ICS20Acknowledgement((address,uint256,address,string,string) packetData, bytes acknowledgement, bool success)
...
// WatchICS20Acknowledgement is a free log subscription operation binding the contract event 0xe89bcee3264240450629e36ea20920e66e8bb6948e95d13fb2dfb8dc1156c55d.
//
// Solidity: event ICS20Acknowledgement((address,uint256,address,string,string) packetData, bytes acknowledgement, bool success)
...
// ParseICS20Acknowledgement is a log parse operation binding the contract event 0xe89bcee3264240450629e36ea20920e66e8bb6948e95d13fb2dfb8dc1156c55d.
//
// Solidity: event ICS20Acknowledgement((address,uint256,address,string,string) packetData, bytes acknowledgement, bool success)
...
// FilterICS20Timeout is a free log retrieval operation binding the contract event 0xe593536479534bcca0405e240e028fe7709ece5e1cfcb82bcee63ec6065c911a.
//
// Solidity: event ICS20Timeout((address,uint256,address,string,string) packetData)
...
// WatchICS20Timeout is a free log subscription operation binding the contract event 0xe593536479534bcca0405e240e028fe7709ece5e1cfcb82bcee63ec6065c911a.
//
// Solidity: event ICS20Timeout((address,uint256,address,string,string) packetData)
...
// ParseICS20Timeout is a log parse operation binding the contract event 0xe593536479534bcca0405e240e028fe7709ece5e1cfcb82bcee63ec6065c911a.
//
// Solidity: event ICS20Timeout((address,uint256,address,string,string) packetData)
...
// FilterICS20Transfer is a free log retrieval operation binding the contract event 0xc8b9eb1385efc079eca447ddeae64f092898d23ffbbddc3915af3e5febb049ee.
//
// Solidity: event ICS20Transfer((address,uint256,address,string,string) packetData)
...
// WatchICS20Transfer is a free log subscription operation binding the contract event 0xc8b9eb1385efc079eca447ddeae64f092898d23ffbbddc3915af3e5febb049ee.
//
// Solidity: event ICS20Transfer((address,uint256,address,string,string) packetData)
...
// ParseICS20Transfer is a log parse operation binding the contract event 0xc8b9eb1385efc079eca447ddeae64f092898d23ffbbddc3915af3e5febb049ee.
//
// Solidity: event ICS20Transfer((address,uint256,address,string,string) packetData)
