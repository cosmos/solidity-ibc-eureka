...
// CreateMsgSendPacket is a free data retrieval call binding the contract method 0xe6b40ae7.
//
// Solidity: function createMsgSendPacket(address sender, (string,uint256,string,string,string,uint64,string) msg_) view returns((string,uint64,(string,string,string,string,bytes)[]))
func (_Contract *ContractCaller) CreateMsgSendPacket(opts *bind.CallOpts, sender common.Address, msg_ IICS20TransferMsgsSendTransferMsg) (IICS26RouterMsgsMsgSendPacket, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "createMsgSendPacket", sender, msg_)
...
//
// Solidity: function createMsgSendPacket(address sender, (string,uint256,string,string,string,uint64,string) msg_) view returns((string,uint64,(string,string,string,string,bytes)[]))
func (_Contract *ContractSession) CreateMsgSendPacket(sender common.Address, msg_ IICS20TransferMsgsSendTransferMsg) (IICS26RouterMsgsMsgSendPacket, error) {
	return _Contract.Contract.CreateMsgSendPacket(&_Contract.CallOpts, sender, msg_)
}

// CreateMsgSendPacket is a free data retrieval call binding the contract method 0xe6b40ae7.
//
// Solidity: function createMsgSendPacket(address sender, (string,uint256,string,string,string,uint64,string) msg_) view returns((string,uint64,(string,string,string,string,bytes)[]))
func (_Contract *ContractCallerSession) CreateMsgSendPacket(sender common.Address, msg_ IICS20TransferMsgsSendTransferMsg) (IICS26RouterMsgsMsgSendPacket, error) {
	return _Contract.Contract.CreateMsgSendPacket(&_Contract.CallOpts, sender, msg_)
}
