...
// CreateMsgSendPacket is a free data retrieval call binding the contract method 0x285b2923.
//
// Solidity: function createMsgSendPacket((string,uint256,string,string,string,uint64,string) msg_) view returns((string,uint64,(string,string,string,string,bytes)[]))
func (_Contract *ContractCaller) CreateMsgSendPacket(opts *bind.CallOpts, msg_ IICS20TransferMsgsSendTransferMsg) (IICS26RouterMsgsMsgSendPacket, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "createMsgSendPacket", msg_)
...
//
// Solidity: function createMsgSendPacket((string,uint256,string,string,string,uint64,string) msg_) view returns((string,uint64,(string,string,string,string,bytes)[]))
func (_Contract *ContractSession) CreateMsgSendPacket(msg_ IICS20TransferMsgsSendTransferMsg) (IICS26RouterMsgsMsgSendPacket, error) {
	return _Contract.Contract.CreateMsgSendPacket(&_Contract.CallOpts, msg_)
}

// CreateMsgSendPacket is a free data retrieval call binding the contract method 0x285b2923.
//
// Solidity: function createMsgSendPacket((string,uint256,string,string,string,uint64,string) msg_) view returns((string,uint64,(string,string,string,string,bytes)[]))
func (_Contract *ContractCallerSession) CreateMsgSendPacket(msg_ IICS20TransferMsgsSendTransferMsg) (IICS26RouterMsgsMsgSendPacket, error) {
	return _Contract.Contract.CreateMsgSendPacket(&_Contract.CallOpts, msg_)
}
