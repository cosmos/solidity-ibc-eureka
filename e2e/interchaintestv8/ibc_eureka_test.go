...
func (s *IbcEurekaTestSuite) updateEthClient(ctx context.Context, minimumUpdateTo int64, simdRelayerUser ibc.Wallet) {
	eth, simd := s.ChainA, s.ChainB
	...
	s.Require().Greater(s.lastUnionUpdate, uint64(minimumUpdateTo))
}
