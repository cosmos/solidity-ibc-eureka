...
contract IFTTest is Test {
    ...
    function test_cosmosCallConstructor_constructMintCall_zeroAmount() public {
        ...
        // Verify "amount":"0" is in the output
        bytes memory expected = abi.encodePacked(
    ...
    function test_cosmosCallConstructor_constructMintCall_largeAmount() public {
        ...
        // Verify the amount is correctly stringified
        bytes memory expected = abi.encodePacked(
    ...
    function test_cosmosCallConstructor_supportsInterface_IIFTSendCallConstructor() public {
        CosmosIFTSendCallConstructor constructor_ =
            new CosmosIFTSendCallConstructor("/wfchain.ift.MsgIFTMint", "testift", "wf1ica");
    ...
    function test_cosmosCallConstructor_supportsInterface_IERC165() public {
        CosmosIFTSendCallConstructor constructor_ =
            new CosmosIFTSendCallConstructor("/wfchain.ift.MsgIFTMint", "testift", "wf1ica");
    ...
    function test_cosmosCallConstructor_supportsInterface_unsupported() public {
        CosmosIFTSendCallConstructor constructor_ =
            new CosmosIFTSendCallConstructor("/wfchain.ift.MsgIFTMint", "testift", "wf1ica");
